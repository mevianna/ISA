...
```
Output:
![arvore_sem_poda](figures/arvore_sem_poda.png)
...
df_importancias = pd.DataFrame(importances, index=data.feature_names)
df_importancias = df_importancias.round(4).sort_values(by="sem_poda", ascending=False)
