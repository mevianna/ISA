...
# Campo de utilização
 O K-means é extremamente utilizado na ciência de dados para segmentação de mercado, portanto esse método pode estruturar a base de clientes em diferentes segmentos relacionados as suas características, além de pode agrupar documentos, realizar a segmentação e compactação de imagens.

 ## Exemplo de utilização - Compressão de imagem
