...
O Naive Bayes se fundamenta no **Teorema de Bayes** para calcular as probabilidades. 
...
Para simplificar, vamos começar com o caso mais simples, onde analisamos apenas **um atributo**, como um email que contém apenas a palavra "ganhe".
...
Queremos calcular a probabilidade a posteriori: se um email contém a palavra "ganhe", é spam ou normal?
...
Observe que o denominador $P(\text{"ganhe"})$ é o mesmo nas duas frações. Para descobrir qual fração é maior, basta comparar os numeradores: $0.072$ e $0.035$.
...
Agora que vimos um exemplo concreto, podemos entender o processo elegante de **atualização de crenças** que o Naive Bayes implementa:
