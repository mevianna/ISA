...
Observe que o denominador $P(\text{"ganhe"})$ é o mesmo nas duas frações. Para descobrir qual fração é maior, podemos simplesmente comparar seus numeradores. A nossa comparação, então, se resume a comparar $0.24$ com $0.035$.
...
Portanto, classificador se torna:
