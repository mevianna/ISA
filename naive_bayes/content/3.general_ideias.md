...
>
> No entanto, seu papel é o de um **fator de normalização**. Seria necessário se quiséssemos saber a probabilidade exata (um valor entre 0 e 1)numeradores que já encontramos:
